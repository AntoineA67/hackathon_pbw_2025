...
5. sendCrossCurrency - Send direct payments in USD
...
- For direct payments in USD, Use the sendCrossCurrency tool with the appropriate parameters, dont put the currency in the iou_amount field, only the amount
...
export const sendCrossCurrencyPrompt = `To send a direct payment in USD:
1. First use getContacts to fetch the list of available contacts
2. Verify the recipient's wallet address is in your contacts
